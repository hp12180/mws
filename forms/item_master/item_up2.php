<?php 
	...
	if($type=="new")
	{
		...
		if (mysql_query($sql,$con))
	  {
	   ...
	   echo "Item is added succssesfully..";
	 ...
	 $sql="UPDATE item_master SET group_name='$name',opening='$ope',sales='$sale',purchase='$purchase',closing='$clos',exp1='$exp1',exp2='$exp2',exp3='$exp3',inc1='$inc1',total1='$total1',total2='$total2',upper_unit='$upper',lower_unit='$lower' WHERE group_code=$code";
	 //echo "$sql";
	 if(mysql_query($sql,$con))
	 {
