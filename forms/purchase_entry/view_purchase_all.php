	...
	var a=confirm("Are you sure want to delete this account ?");
		if(a)
		{
			...
			$("#demo").load("forms/purchase_entry/purchase_delete.php",{bill_no:bill_no},function(responseText){  
					...
					$("#my_sub_div").load("forms/purchase_entry/view_purchase_all.php",function(rt){
...
<?php 
	...
	else 
	{
		...
		$str.='<table id="view_purchase_all" class="mws-datatable mws-table">
			<thead>
				<tr>
					<th>Entry ID</th>
					<th>Bill No</th>
